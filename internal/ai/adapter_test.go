...
func TestCompileAdapterPromptAndRegistration(t *testing.T) {
	...
	if err != nil || version != "v3" || !strings.Contains(system, "function next") || !strings.Contains(system, "candidateQueryRef") || !strings.Contains(system, "satisfied/changed/failed/unknown/ready") || !strings.Contains(user, "compile-1") {
